...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-white/60 rounded-2xl p-6 py-8 backdrop-blur-xl border border-slate-200">
      <h3
        className="text-xl font-semibold text-black mb-6 flex items-center gap-2"
        data-aos="fade-down"
      >
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-lg 
                     ...
                     hover:border-transparent hover:shadow-lg transition-all duration-500"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          ...
          {/* Content Container - DIBERI Z-INDEX 10 AGAR DI ATAS GRADIENT */}
          <div className="relative flex items-center gap-4 z-10">
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative p-2 rounded-md">
                <linkedIn.icon
                  className="w-6 h-6 transition-all duration-500 group-hover:scale-105 group-hover:brightness-0 group-hover:invert"
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-slate-900 tracking-tight leading-none group-hover:text-white transition-colors duration-300">
                {linkedIn.displayName}
              </span>
              <span className="text-sm text-slate-600 group-hover:text-white/80 transition-colors duration-300">
                {linkedIn.subText}
              </span>
            </div>
          </div>
          ...
          <ExternalLink
            className="relative w-5 h-5 text-slate-900 group-hover:text-white
                       opacity-0 group-hover:opacity-100 transition-all duration-300
                       transform group-hover:translate-x-0 -translate-x-1 z-10"
          />
        </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, youtube].map((link, index) => (
            ...
            >
              ...
              {/* Content Container - DIBERI Z-INDEX 10 */}
              <div className="relative flex items-center justify-center z-10">
                ...
                <div className="relative p-2 rounded-lg">
                  <link.icon
                    className="w-5 h-5 transition-all duration-500 group-hover:scale-110 group-hover:brightness-0 group-hover:invert"
              ...
              <div className="flex flex-col min-w-0 z-10">
                <span className="text-sm font-bold text-slate-900 group-hover:text-white transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-xs text-slate-600 truncate group-hover:text-white/80 transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink
                className="w-4 h-4 text-slate-900 group-hover:text-white ml-auto
                           opacity-0 group-hover:opacity-100 transition-all duration-300
                           transform group-hover:translate-x-0 -translate-x-2 z-10"
              />
            </a>
          ))}
        </div>
